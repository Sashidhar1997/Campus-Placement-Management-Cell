<%-- 
    Document   : stu_list.jsp
    Created on : 9 Mar, 2019, 5:52:55 PM
     ...
     while(rs2.next()){
       img=rs2.getString(2);
                ...
                %><tr>
                    ...
                    <td>
                  <form action="admin_edit_stu.jsp" method="GET" >
            <button type="submit" name="submit" class="btn btn-primary" value="<%= rs.getString("sid") %>">Edit</button>
                  </form></td>
                  <td> 
                      <form action="admin_del_stu.jsp" method="GET" >
            <button type="submit" name="submit" class="btn btn-primary" value="<%= rs.getString("sid") %>">Delete</button>
                      </form>
                  </td>
                  <td> 
                      <form action="admin_msg_stu.jsp" method="GET" >
