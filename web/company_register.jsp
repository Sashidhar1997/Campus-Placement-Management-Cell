<!DOCTYPE html>
<html lang="en">
<title>Comapany Registration form</title>
<meta charset="UTF-8">
              ...
              <div class="col-sm-6" style="padding-left: 45px;">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      ...
                      <form class="signup-form" action="company_store.jsp" method="post">
                       <div class="form-group">
                          <label for="cname">Company Name:</label>
                          <input type="text" class="form-control" name="cname" placeholder="Enter Company Name" pattern="[a-zA-Z]{1,30}" title="Name does contain symbols and numbers">
                        </div>
                        <div class="form-group"> 
                        ...
                        <div class="form-group"> 
                          <label for="SeatsOffered">Seats Offer:</label>
                          <input type="text" class="form-control" name="seatsoffered" placeholder="SeatsOffered" pattern="[0-9]{1,3}">
                        </div>
                          <div class="form-group"> 
                          <label for="SeatsOffered">Salary:</label>
                          <input type="text" class="form-control" name="salary" placeholder="Salary" pattern="[0-9]{1,10}">
                        </div>

                        
                        <div class="form-group">
                          <label for="cgpabt">Minimum CGPA FOR B.TECH:</label>
                          <input type="number" class="form-control" name="cgpabt" placeholder="criteria" min="0" max="10" step="0.01">
                        </div>
                          <div class="form-group">
                          <label for="cgpamt">Minimum CGPA FOR M.TECH:</label>
                          <input type="number" class="form-control" name="cgpamt" placeholder="criteria" min="0" max="10" step="0.01">
                        </div>
                          <div class="form-group">
                          <label for="cgpam">Minimum CGPA FOR MCA:</label>
                          <input type="number" class="form-control" name="cgpam" placeholder="criteria" min="0" max="10" step="0.01">
                        </div>
                        ...
                        <br><br>
                        <a href="company_login.jsp">Back To Log in</a>
