<%-- 
    Document   : admin_stuinbox
    Created on : 15 Mar, 2019, 9:52:17 AM
    Author     : sashidhar
--%>
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
   ...
   <%    
    ...
    try{
        ...
        String q="select * from stu_to_admin where to_add='"+admin+"'";
        ...
        while(rs.next()){
                ...
                %><tr>
                    ...
                    <td><form action="admin_msg_stu.jsp" method="GET">
                        <input type="hidden" name="admin" value="<%=rs.getString("to_add")%>">
                       <input type="hidden" name="sid" value="<%=rs.getString("from_add")%>">
