<%-- 
    Document   : stu_admininbox
    Created on : 15 Mar, 2019, 10:08:45 AM
    Author     : sashidhar
--%>
 ...
 <h1>Messages from admin</h1>
   ...
   <%    
    ...
    try{
        ...
        //Statement st=con.createStatement();
        String q="select * from stu_to_admin where from_add='"+admin+"' and to_add='"+sid+"'";
       ...
       //         Statement st=con.createStatement();
            ...
            /*     String q="Insert into login values (?,?)";
              ...
              pst.executeUpdate();*/
                ...
                <form action="stu_msg_admin_res.jsp" method="GET">
