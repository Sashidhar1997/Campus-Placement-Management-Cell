<!--
in Admin panel.... this is the jsp page which will delete the company and redirect to the list of companies
-->
...
<html>
    <head>
        ...
        <%
            ...
            String cname=request.getParameter("submit");
            String q="delete from company where cname='"+cname+"'";
            ...
            /*     String q="Insert into login values (?,?)";
              ...
              pst.executeUpdate();*/
                ...
                //session.setAttribute("userid",email);
                 Thread.sleep(10);
                %>
                <jsp:include page="company_list.jsp"></jsp:include>
                <%
