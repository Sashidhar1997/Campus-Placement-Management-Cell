<%-- 
    ...
    Created on : 11 Mar, 2019, 11:28:07 AM
...
<!-- uploading a Resume -->    
    <form method="post" action="upload_resume_check.jsp">
        <table>
            
            <tr>
                <td><input type="hidden" name="sid" value="<%=(String)session.getAttribute("sid")%>"></td>
    ...
    <form method="post" action="stu_view_resume.jsp">
