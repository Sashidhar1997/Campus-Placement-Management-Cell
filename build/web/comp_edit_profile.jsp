<%-- 
    Document   : comp_edit_profile.jsp
    Created on : 11 Mar, 2019, 9:19:21 PM
--%>
...
String q1="select * from company where email='"+email+"'";
    ResultSet rs1=st.executeQuery(q1);  
    
while(rs1.next()){
%>
                     <form class="signup-form" action="comp_update.jsp" method="post">
                       <input type="hidden" name="id" value="<%=rs1.getString("email") %>">

                        <div class="form-group">
                          <label for="fname">cname:</label>
                          <input type="text" class="form-control" name="cname" value="<%=rs1.getString("cname") %>"readonly="readonly">
                        </div>

                        <div class="form-group"> 
                          <label for="lname">email:</label>
                          <input type="text" class="form-control" name="mail" value="<%=rs1.getString("email") %>" readonly="readonly">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="seat">Seats offered:</label>
                          <input type="text" class="form-control" name="seats" value="<%=rs1.getString("seats_offered") %>">
                        </div>
                      
                        <div class="form-group">
                          <label for="cgpa">Min cgpa:</label>
                          <input type="text" class="form-control" name="cgpa" value="<%=rs1.getString("min_cgpa") %>">
                        </div>

                        <div class="form-group"> 
                          <label for="phone">Phone:</label>
                          <input type="text" class="form-control" name="phone" value="<%=rs1.getString("phone") %>">
                        </div>
                        <div class="form-group"> 
                          <label for="about">About:</label>
                          <input type="text" class="form-control" name="about" value="<%=rs1.getString("about") %>">
                        </div>
