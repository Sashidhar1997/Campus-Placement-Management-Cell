<!DOCTYPE html>
<html lang="en">
<title>Comapany Login form</title>
<meta charset="UTF-8">
     ...
     <div class="container">
              ...
              <div class="col-sm-6" style="padding-left: 45px;">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      ...
                      <form  action="comp_login_res.jsp" method="POST">
       ...
       <input type="submit" name="submit" value="Sign In">  
        ...
        <div class="text-left" style="font-size: 14px;"><br>
            <span class="no__account"><i>Don't have an account.?</i><a href="company_register.jsp" class="account__regiter"> Sign Up </a></span>
        </div><br>
        <div class="text-left" style="font-size: 14px;"><br>
