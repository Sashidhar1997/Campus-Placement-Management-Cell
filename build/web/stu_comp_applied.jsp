<%-- 
    Document   : stu_comp_applied.jsp
    Created on : 10 Mar, 2019, 3:28:35 PM
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <tbody>
       <% 
            ...
            int count=0;
            q="select * from company where cname in (select cname from stu_comp where sid='"+sid+"')";
     ...
     while(rs2.next()){
       img=rs2.getString(2);
                %><tr>
                    ...
                    <td><form action="message1.jsp" method="GET">
            ...
            if(count==0){
                out.println("No Companies Added......");
            }
        }
        catch(Exception e){
